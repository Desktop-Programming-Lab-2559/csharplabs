# Лабораторна робота 14
 ...
 створення правильної трикутної та чотирикутної призми. Випадковим чином створити певну кількість трикутних та чотирикутних призм, щоб їх сумарна кількість дорівнювала n. Для трикутних призм знайти сумарний об’єм, а для чотирикутних – суму площ
 поверхні. 
```cs
    Prism.cs
